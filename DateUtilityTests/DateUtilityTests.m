...
- (void)testDatesToYearFromCurrentDateDays {
    ...
    NSMutableArray *dates = [DateUtility datesToYearFromCurrentDate:myDate days:days];
...
- (void)testDatesToYearFromCurrentDateDaysWithYear {
    ...
    NSMutableArray *dates = [DateUtility datesToYearFromCurrentDate:myDate days:days withYears:year];
    returnDate = [dates objectAtIndex:1];
    NSDateComponents *returnDateComponents = [[NSCalendar currentCalendar]
                                              components:NSCalendarUnitDay |
                                              NSCalendarUnitMonth |
    ...
    dates = [DateUtility datesToYearFromCurrentDate:myDate days:days withYears:year];
    returnDate = [dates objectAtIndex:1];
